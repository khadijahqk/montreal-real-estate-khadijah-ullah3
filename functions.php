...
function montreal_real_estate_theme_scripts() {
    wp_enqueue_style( 'montreal_real_estate-khadijah-ullah-3', get_stylesheet_uri() );
}
...
function add_my_menus() {
    register_nav_menus(
    array(
        'header-menu' => __( 'Header Menu', 'montreal-real-estate-khadijah-ullah-3' ),
        'footer-menu' => __( 'Footer Menu', 'montreal-real-estate-khadijah-ullah-3' ),
        'social-menu' => __( 'Social Menu', 'montreal-real-estate-khadijah-ullah-3'),
